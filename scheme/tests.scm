...
(define foo (print 'bar)) ;Q5
; expect foo

(define x 12) ;Q6 and Q7

'(list 10 11 x 13) ;Q6 and Q7
; expect (list 10 11 x 13)

`(list 10 11 ,x 13) ;Q6 and Q7
; expect (list 10 11 12 13)

(list 10 11 x 13) ;Q6 and Q7
; expect (10 11 12 13)


(begin (begin (* 2 3) (print 2)) (+ 4 5)) ;Q8
; expect 9

(lambda (var) (begin (+ 2 3) (+ 4 5))) ;Q9
; expect (lambda (var) (begin (+ 2 3) (+ 4 5)))

((lambda (var) (begin (+ 2 3) (+ var 5))) 10) ;Q9
; expect 15

(define (name g) (print 'test)) ;Q10
; expect name

name ;Q10
;expect (lambda (g) (print (quote test)))
...
(and (+ 3 4) 0 1 'string #t) ;Q13
; expect #t

(and (+ 3 4) 0 1 'string #f) ;Q13
; expect #f

(or (> 5 7) (odd? 4) (lambda (x) (+ x 1))) ;Q13
; expect (lambda (x) (+ x 1))

(or (define foo (print 'bar)) (odd? 4) (even? 2)) ;Q13
; expect foo

(or (> 5 7) (odd? 4) (even? 3)) ;Q13
; expect #f
...
(let ((x 1) (y 5) (lamb (lambda (y) (+ y 1)))) ;Q15
  (list x y lamb)
)
; expect (1 5 (lambda (y) (+ y 1)))
...
(define mu-func (mu () (+ a b c))) ;Q16
; expect mu-func
(define mu-test (lambda () (define a 5) (define b 10) (define c 15) (mu-func)))
; expect mu-test
(mu-test)
;expect 30
; END PROBLEM 0
